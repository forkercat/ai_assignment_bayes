...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Apr 7 22:13:06 2017
...
SOURCES       = main.cpp qrc_application.cpp
OBJECTS       = main.o \
		qrc_application.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/ai_assignment_bayes1.0.0/ && (cd `dirname .tmp/ai_assignment_bayes1.0.0` && $(TAR) ai_assignment_bayes1.0.0.tar ai_assignment_bayes1.0.0 && $(COMPRESS) ai_assignment_bayes1.0.0.tar) && $(MOVE) `dirname .tmp/ai_assignment_bayes1.0.0`/ai_assignment_bayes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ai_assignment_bayes1.0.0
