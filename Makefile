...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Apr 8 09:33:26 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents mydialog.h .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents mydialog.cpp main.cpp .tmp/ai_assignment_bayes1.0.0/ && (cd `dirname .tmp/ai_assignment_bayes1.0.0` && $(TAR) ai_assignment_bayes1.0.0.tar ai_assignment_bayes1.0.0 && $(COMPRESS) ai_assignment_bayes1.0.0.tar) && $(MOVE) `dirname .tmp/ai_assignment_bayes1.0.0`/ai_assignment_bayes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ai_assignment_bayes1.0.0
