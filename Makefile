...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Apr 8 23:25:57 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents mydialog.h sample.h jhparser.h jhbayes.h .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents application.qrc .tmp/ai_assignment_bayes1.0.0/ && $(COPY_FILE) --parents mydialog.cpp sample.cpp jhparser.cpp jhbayes.cpp main.cpp .tmp/ai_assignment_bayes1.0.0/ && (cd `dirname .tmp/ai_assignment_bayes1.0.0` && $(TAR) ai_assignment_bayes1.0.0.tar ai_assignment_bayes1.0.0 && $(COMPRESS) ai_assignment_bayes1.0.0.tar) && $(MOVE) `dirname .tmp/ai_assignment_bayes1.0.0`/ai_assignment_bayes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ai_assignment_bayes1.0.0
...
jhbayes.o: jhbayes.cpp jhbayes.h \
		sample.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o jhbayes.o jhbayes.cpp
